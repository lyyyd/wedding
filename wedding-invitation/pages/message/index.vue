<template>
    <div class="message">
                ...
                <div class="right">
                    <div class="top">
                      <div class="delete" @tap="deleteMessage(item)">
                        <image src="https://7463-tcb-6d2s2hjt37fj65c-9cc5a099c55b-1316556253.tcb.qcloud.la/wp/close.png" class="delete_icon" v-if="item._openid === openId || isAdmin"/>
                      </div>
        ...
        <div class="video-dialog"  @tap="toVideo" v-if="url !== '' && url !== undefined">
            <image src="https://7463-tcb-6d2s2hjt37fj65c-9cc5a099c55b-1316556253.tcb.qcloud.la/wp/video1.png"/>
        </div>
        <div class="form-dialog" @tap="lookList">
            <image src="https://7463-tcb-6d2s2hjt37fj65c-9cc5a099c55b-1316556253.tcb.qcloud.la/wp/form.png"/>
        </div>
